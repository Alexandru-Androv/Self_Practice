...
public class HttpStatusCode {
    public static void main(String[] args) {
        ...
        switch (statusCode) {
            ...
            case 401 -> System.out.println("Unautorized");
            case 403 -> System.out.println("Forbiden");
            case 404 -> System.out.println("Not Found");
            case 410 -> System.out.println("Gone");
            case 500 -> System.out.println("Internal Service Eror");
            case 503 -> System.out.println("Service Unavailiable");
            default -> System.out.println("EROR:Status code not found");
        }
